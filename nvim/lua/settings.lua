...
-- Allow sepecified keys to move to the prev/next object they're maneuviring around
...
opt.undofile = true -- enable persisten undo TODO: Check this, it looks dangerous
